...
.payment-options input[type="radio"]:checked + label {
  ...
  <div class="main">
    ...
    <div class="payment-options">
        ...
        <label id="LISTENING" for="Dinliyor">Dinliyor</label>
        <label id="WATCHING" for="İzliyor">İzliyor</label>
        <label id="COMPETING" for="Yarışıyor">Yarışıyor</label>
        <label id="STREAMING" for="Canlı">Canlı</label>
        <label id="PLAYING" for="Oynuyor">Oynuyor</label>
